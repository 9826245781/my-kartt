...
function Login() {
    ...
    const register = e => {
        e.preventDefault();
        //some fancy firevase stuff
        auth
            .createUserWithEmailAndPassword(email, password)
            .then((auth) => {
                //it is successfull with email and password
                console.log(auth);
                if (auth) {
                    navigate('/')
                }
